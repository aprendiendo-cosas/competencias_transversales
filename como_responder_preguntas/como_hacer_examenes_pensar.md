...
+ Pensamiento crítico: cuestionar con argumentos lógicos las afirmaciones presentadas.
...
#### 1. Leer y entender la pregunta (5')
...
En este primer paso no recomiendo que uséis herramientas de IA. Estas herramientas son aún muy primitivas y tienen una capacidad explicativa relativa. En cualquier caso, si preguntáis, hacedlo de la forma más específica y detallada posible. Además, si hacéis vosotros el esfuerzo de entender bien la pregunta, aprenderéis más. Este esfuerzo activará vuestra memoria a largo plazo y esto permitirá que salga a relucir el conocimiento que tenéis sobre el asunto en cuestión.



#### 2. Identificar conceptos e ideas clave de la pregunta (5')
...
Fíjate que no estamos aún intentando responder a la pregunta. No sabemos responder a la pregunta general. Lo que estamos haciendo es identificar los elementos clave de la misma. Es como si rompiéramos la pregunta general en piezas pequeñas más abordables. Estas preguntas más sencillas sí que pueden tener respuestas sencillas. Esta fase es una especie de transición entre la comprensión de la pregunta (nivel cognitivo básico) y su análisis más profundo. Esto último requiere una mayor capacidad cognitiva.

#### 3. Establecer relaciones de los conceptos anteriores con las teorías ecológicas (5')
Al leer la pregunta y al tratar de identificar conceptos clave te deben de venir a la cabeza relaciones con aspectos que hemos visto en la asignatura. Nuestro cerebro es una maquina relacional. Esto quiere decir que aprender a partir de la relación entre conceptos. Por ejemplo, sabemos que una silla es una silla porque la comparamos con otras cosas parecidas que no son una silla (ej. una cama). Este ejemplo es muy obvio, pero funciona así en general. Si en el enunciado de la pregunta lees algo así: "el fuego calcinó todo el bosque excepto los invididuos más altos y viejos", tu cerebro debería devolverte los siguientes conceptos (entre otros):
...
Esta especie de "devolución" automática de tu cerebro ocurrirá solo si has estudiado con profundidad el temario teórico de la asignatura y lo has comprendido en su totalidad. Aunque parezca un proceso automático, requiere un esfuerzo cognitivo alto porque implica identificar patrones y conexiones entre conceptos.
...
#### 4. Buscar información sobre aspectos desconocidos por tí (10')
...
+ Mientras construyes el mapa, para en cada conexión entre ideas y pregúntate: '¿Por qué esta idea se conecta causalmente con esa?' Si no puedes responder, probablemente la conexión no es válida o necesitas información adicional.
...
+ Una vez que tengas un hilo argumental que te guste, puedes evaluarlo haciendo preguntas como estas:
  + ¿Está cada párrafo conectado causalmente con el anterior, o solo agregado de ideas?
  + ¿Hay un concepto en mi mapa mental que no aparece en la respuesta?, ¿Por qué lo dejé fuera?
  + ¿Dónde hay incertidumbre en mi razonamiento? ¿Está explícita?
...
Si completas los cinco primeros pasos sin ninguna incertidumbre, probablemente la pregunta no es suficientemente desafiante. El aprendizaje reflexivo requiere navegar la incertidumbre—es incómodo, pero eso es señal de que estás aprendiendo profundamente.

#### 6. Escribir la respuesta a la pregunta (15')
...
Si además del texto pones en la respuesta tus notas o el hilo argumental que has utilizado, me ayudarás a entender mejor cómo y qué has aprendido. 
